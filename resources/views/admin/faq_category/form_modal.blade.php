    ...
    <div class="modal-content modal-content-demo">
        ...
        <div class="modal-body text-start">
            ...
            <?php } ?>
                ...
                <div class="col-sm-8">
                    <input type="text" name="top_category_ja_name" class="mt-2 form-control form-control-lg" id="top_category_ja_name" tabindex="1" autofocus autocomplete="off" value="{{$top_category_ja_name ? $top_category_ja_name : ''}}" placeholder="システム(JP)" maxlength="100">
                    @error('top_category_ja_name')
                ...
                <div class="col-sm-8">
                    <input type="text" name="sub_category_ja_name" value="{{$sub_category_ja_name ? $sub_category_ja_name : ''}}" tabindex="2" autocomplete="off" class="mt-2 form-control form-control-lg" id="sub_category_ja_name" placeholder="カテゴリ名(JP)" maxlength="100">
                    @error('sub_category_ja_name')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="col-sm-8">
                    <input type="text" name="top_category_en_name" value="{{$top_category_en_name ? $top_category_en_name : ''}}" tabindex="3" autocomplete="off" class="mt-2 form-control form-control-lg" id="top_category_en_name" placeholder="システム(EN)" maxlength="100">
                    @error('top_category_en_name')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="col-sm-8">
                    <input type="text" name="sort" tabindex="5" autocomplete="off" value="{{$sort ? $sort : ''}}" class="mt-2 form-control form-control-lg" id="sort" placeholder="0" min="0" maxlength="3">
                    @error('sort')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
                ...
                <div class="col-sm-8">
                    <input type="text"  name="mail_form_id" tabindex="7" autocomplete="off" value="{{$mail_form_id ? $mail_form_id : ''}}" class="mt-2 form-control form-control-lg" id="mail_form_id" placeholder="0" min="0" maxlength="3">
                    @error('mail_form_id')
                    <span class="text-danger">{{ $message }}</span>
                    @enderror
                </div>
