                                    ...
                                    <div class="modal-content modal-content-demo">
                                        ...
                                        <div class="modal-body text-start">
                                            <div class="row">
                                                ...
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control form-control-lg" id="colFormLabelLg" placeholder="カテゴリ名 (EN)">
                                                </div>
                                                <label for="colFormLabelLg" class="col-sm-4 col-form-label col-form-label">表示順</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control form-control-lg" id="colFormLabelLg" placeholder="表示順">
                                                </div>
                                                <label for="colFormLabelLg" class="col-sm-4 col-form-label col-form-label">状態</label>
                                                <div class="col-sm-8">
                                                    <input type="text" class="form-control" placeholder="状態">
                                                </div>
