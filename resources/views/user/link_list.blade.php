    ...
    <div class="d-md-flex d-block align-items-center justify-content-between mt-2 page-header-breadcrumb">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb breadcrumb-style2 mb-0">
                ...
                <li class="breadcrumb-item"><a href="javascript:void(0);">リンク</a></li>
                <li class="breadcrumb-item active" aria-current="page">リンク一覧</li>
            </ol>
        </nav>
                        ...
                        <div class="card custom-card">
                            ...
                            <div class="card-body text-end">
                                ...
                                <div class="col-xxl-12 col-xl-12 col-lg-12 pb-5 px-lg-2 px-5 text-start">
                                    <div class="faq-list">
                                        <a href="#">
                                            <h6 class="text-lg-start fw-semibold mb-2">登録されたサイト名はここに表示されます。</h6>
                                            <p class="text-muted w-75 mb-0">サイトの説明を表示する。サイトの説明を表示する。サイトの説明を表示する。サイトの説明を表示する。サイトの説明を表示する。「・・・」 で省略···</p>
                                        </a>
                                    </div>
                                    <div class="faq-list">
                                        <a href="#">
                                    ...
                                    <div class="faq-list">
                                        <a href="#">
                                            <h6 class="text-lg-start fw-semibold mb-2">登録されたサイト名はここに表示されます。</h6>
                                            <p class="text-muted w-75 mb-0">サイトの説明を表示する。サイトの説明を表示する。サイトの説明を表示する。サイトの説明を表示する。「・・・」 で省略···</p>
                                        </a>
                                    </div>
                                </div>
