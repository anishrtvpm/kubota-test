            ...
            <div class="header-element">
                <a href="#" class="header-link dropdown-toggle" id="mainHeaderProfile" data-bs-toggle="dropdown" data-bs-auto-close="outside" aria-expanded="false">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="ms-sm-2 me-0">
                            <img src="{{ asset('images/profile/1.jpg') }}" alt="img" width="32" height="32" class="rounded-circle">
                        </div>
                    </div>
                </a>
                <div class="main-header-dropdown dropdown-menu pt-0 overflow-hidden header-profile-dropdown dropdown-menu-end" aria-labelledby="mainHeaderProfile">
                    <div class="d-flex mb-2 mt-2">
                        <div class="p-2 flex-shrink-1"> <img src="{{ asset('images/profile/1.jpg') }}" alt="img" width="60" height="60" class="rounded-circle"></div>
                    ...
                    <div class="row mb-1">
                        ...
                        <div class="col-xl-3">
                            <div class="form-check form-check-lg">
                                <input class="form-check-input" type="radio" name="Radio" id="Radio-lg1" checked="">
